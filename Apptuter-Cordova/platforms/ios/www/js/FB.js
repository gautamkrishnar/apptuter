var Main = function () {
    this.pageName = '312179148823296'; //Here you will need to insert your page Id.
    this.src = null;
    this.name = null;
    this.category = null;
    ...
    this.infoArray = [];
    this.postCount = 0;
    this.accessToken = '827735253926275|acece813d786a2d1befdfc86e0abe850'; //Here will be your Facebook Access_Token
